...
import com.example.sistemidigitali.utils.AutoFitTextureView
import java.util.*
import java.util.concurrent.Semaphore
import java.util.concurrent.TimeUnit

/**
 * Fragment che si occupa della connessione con la fotocamera e dello stream dei frames
 *
 */
...
class CameraConnectionFragment @SuppressLint("ValidFragment") private constructor(
    ...
    private val imageListener: OnImageAvailableListener, //un OnImageAvailableListener per ricevere i frames quando sono disponibili
    private val layout: Int, //identificatore del layout di questo fragment
    private val inputSize: Size //dimensione della finestra di visualizzazione
) : Fragment() {  
    companion object {
        /**
    ...
    private fun createCameraPreviewSession() {
        try {
            ...
            // aWe set up  CaptureRequest.Builder with the output Surface.
            ...
            previewReader!!.setOnImageAvailableListener(imageListener, backgroundHandler) //Setta la main activity come imageListener
